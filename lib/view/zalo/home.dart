...
import '../../repository/payment_zalo/payment_zalo.dart';
...
class _HomeState extends State<Home> {
  ...
  final valuaStyle = const TextStyle(
    color: Colors.amber,
    fontSize: 18.0,
  ...
  void _onEvent(dynamic event) {
    ...
    if (event is Map<String, dynamic>) {
      ...
      print("Error: Event is not a Map<String, dynamic>");
    }
  }
        ...
        child: Visibility(
          ...
          onTap: () async {
            ...
            try {
              ...
              response = result;
              print('đây là response: $response');
